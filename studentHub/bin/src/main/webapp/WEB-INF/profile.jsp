...
<body data-home-page="Home.html" data-home-page-title="Home"
	class="u-body u-gradient"
	style="background-image: linear-gradient(#808080, #858e99);">
	<header class="u-clearfix u-gradient u-header u-header" id="sec-935a">
			...
			<div class="u-clearfix u-gutter-0 u-layout-wrap u-layout-wrap-1">
				<div class="u-layout">
					<div class="u-layout-row">
						<div
							class="u-container-style u-layout-cell u-left-cell u-size-23 u-layout-cell-1">
							<div class="u-container-layout u-container-layout-1">
								<div alt="" class="u-image u-image-circle u-image-1" src=""
									data-image-width="256" data-image-height="256"></div>
								<h2 class="u-text u-text-custom-color-2 u-text-2">
						...
						<div
							...
							<div class="u-container-layout u-container-layout-2">
								<h2 class="u-text u-text-custom-color-2 u-text-4">User
									Courses:</h2>
										...
										<c:forEach items="${courses }" var="course">
											...
											<div class="u-container-style u-list-item u-repeater-item">
												<div
													...
													<p
														class="u-text u-text-custom-color-2 u-text-default u-text-5">
														<a
															class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-custom-color-2 u-btn-2"
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			<div
				...
				<a class="u-social-url" title="facebook" target="_blank" href=""><span
					class="u-icon u-icon-circle u-social-facebook u-social-icon u-icon-1"><svg
							...
							<use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-6047"></use></svg> <svg class="u-svg-content"
							viewBox="0 0 112 112" x="0" y="0" id="svg-6047">
            ...
            c0-6.7,3.1-17,17-17h12.5v13.9H73.5z"></path></svg></span>
					...
					class="u-icon u-icon-circle u-social-icon u-social-twitter u-icon-2"><svg
							...
							viewBox="0 0 112 112" style="">
							<use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-ffd7"></use></svg> <svg class="u-svg-content"
							viewBox="0 0 112 112" x="0" y="0" id="svg-ffd7">
            ...
            c2.7-0.3,5.3-1,7.7-2.1C88.7,43,86.4,45.4,83.8,47.3z"></path></svg></span>
					...
					class="u-icon u-icon-circle u-social-icon u-social-instagram u-icon-3"><svg
							...
							viewBox="0 0 112 112" style="">
							<use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-b346"></use></svg> <svg class="u-svg-content"
							viewBox="0 0 112 112" x="0" y="0" id="svg-b346">
							<circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
							<path fill="#FFFFFF"
            ...
            c5.5,0,9.9,4.5,9.9,9.9V73.3z"></path></svg></span>
					...
					class="u-icon u-icon-circle u-social-icon u-social-linkedin u-icon-4"><svg
							...
							viewBox="0 0 112 112" style="">
							<use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-fea1"></use></svg> <svg class="u-svg-content"
							viewBox="0 0 112 112" x="0" y="0" id="svg-fea1">
							<circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
							<path fill="#FFFFFF"
