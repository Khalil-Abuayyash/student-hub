...
<body class="main-bg">
    <div class="login-container text-c animated flipInX">
            ...
            <div class="container-content">
                <form:form class="margin-t" method="POST" action="/courses/${id}" modelAttribute="course">
                    ...
                    <button type="submit" class="form-button button-l margin-b">Update Course!</button>
