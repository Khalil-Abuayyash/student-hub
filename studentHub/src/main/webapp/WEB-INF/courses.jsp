...
<head>
  ...
  <script class="u-script" type="text/javascript" src="js/courses_jquery.js" defer=""></script>
  <script class="u-script" type="text/javascript" src="js/courses_nicepage.js" defer=""></script>
    <script class="u-script" type="text/javascript" src="js/header_jquery.js" defer=""></script>
  <script class="u-script" type="text/javascript" src="js/header_nicepage.js" defer=""></script>
...
<body data-home-page="Home.html" data-home-page-title="Home" class="u-body">
      ...
      <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-spacing-20 u-unstyled u-nav-1">
            ...
            <li class="u-nav-item"><a
                class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-custom-color-3 u-text-grey-90 u-text-hover-palette-2-base"
                href="Courses.html" style="padding: 10px;">Courses</a>
            </li>
            <li class="u-nav-item"><a
                class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-custom-color-3 u-text-grey-90 u-text-hover-palette-2-base"
                href="Profile.html" style="padding: 10px;">Profile</a>
            </li>
          </ul>
        </div>
          ...
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                ...
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Courses.html"
                    style="padding: 10px;">Courses</a>
                </li>
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="Profile.html"
                    style="padding: 10px;">Profile</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <button class="u-search-button" type="submit">
          <span class="u-search-icon u-spacing-10">
            <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 56.966 56.966">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-3aec"></use>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
              id="svg-3aec" x="0px" y="0px" viewBox="0 0 56.966 56.966" style="enable-background:new 0 0 56.966 56.966;"
  ...
  <section class="u-align-center u-clearfix u-gradient u-section-2" id="sec-a0cc">
    <div class="u-clearfix u-sheet u-sheet-1">
      <h2 class="u-text u-text-custom-color-1 u-text-default u-text-1">Courses</h2>
      <div class="u-list u-list-1">
        <div class="u-repeater u-repeater-1">
          <c:forEach items="${courses}" var="course">
            <div class="u-align-center u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-container-layout-8"><span
                  class="u-custom-color-2 u-file-icon u-icon u-icon-circle u-spacing-10 u-icon-8"><img src="images/R.png"
                    alt=""></span>
      ...
      <div class="u-align-left u-social-icons u-spacing-10 u-social-icons-1">
        <a class="u-social-url" title="facebook" target="_blank" href=""><span
            class="u-icon u-icon-circle u-social-facebook u-social-icon u-icon-1"><svg class="u-svg-link"
              ...
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-6047"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-6047">
        ...
        <a class="u-social-url" title="twitter" target="_blank" href=""><span
            class="u-icon u-icon-circle u-social-icon u-social-twitter u-icon-2"><svg class="u-svg-link"
              preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-ffd7"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-ffd7">
        ...
        <a class="u-social-url" title="instagram" target="_blank" href=""><span
            class="u-icon u-icon-circle u-social-icon u-social-instagram u-icon-3"><svg class="u-svg-link"
              preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-b346"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-b346">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
              <path fill="#FFFFFF"
        ...
        <a class="u-social-url" title="linkedin" target="_blank" href=""><span
            class="u-icon u-icon-circle u-social-icon u-social-linkedin u-icon-4"><svg class="u-svg-link"
              preserveAspectRatio="xMidYMin slice" viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-fea1"></use>
            </svg><svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-fea1">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
