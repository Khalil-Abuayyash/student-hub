...
<body data-home-page="Home.html" data-home-page-title="Home"
	...
	<footer class="u-clearfix u-footer u-gradient u-footer" id="sec-6ea7">
		<div class="u-clearfix u-sheet u-sheet-1">
            ...
            </svg></span> </a> <a class="u-social-url" title="linkedin" target="_blank"
					href=""><span
					class="u-icon u-icon-circle u-social-icon u-social-linkedin u-icon-4"><svg
							class="u-svg-link" preserveAspectRatio="xMidYMin slice"
							viewBox="0 0 112 112" style="">
              <use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-fea1"></use>
            </svg>
						<svg class="u-svg-content" viewBox="0 0 112 112" x="0" y="0"
							id="svg-fea1">
              <circle fill="currentColor" cx="56.1" cy="56.1" r="55"></circle>
