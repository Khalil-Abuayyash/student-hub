...
<script class="u-script" type="text/javascript" src="js/admin1.js"
	defer=""></script>
<script class="u-script" type="text/javascript" src="js/admin2.js"
	defer=""></script>
...
<body data-home-page="About.html" data-home-page-title="About"
	class="u-body">
	<header class="u-clearfix u-gradient u-header u-header" id="sec-6d65">
				...
				<div class="u-custom-menu u-nav-container">
					<ul class="u-nav u-spacing-20 u-unstyled u-nav-1">
						<li class="u-nav-item"><a
							...
							href="/universities/new" style="padding: 10px;">Add Uninversity</a></li>
						<li class="u-nav-item"><a
							class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-custom-color-3 u-text-grey-90 u-text-hover-palette-2-base"
							href="#" style="padding: 10px;">Add User</a></li>
						<li class="u-nav-item"><a
							class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-custom-color-3 u-text-grey-90 u-text-hover-palette-2-base"
							href="/courses/new" style="padding: 10px;">Add Course</a></li>
						<li class="u-nav-item"><a
							class="u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-custom-color-3 u-text-grey-90 u-text-hover-palette-2-base"
						...
						<div class="u-sidenav-overflow">
							...
							<ul
								...
								<li class="u-nav-item"><a class="u-button-style u-nav-link"
									href="/universities/new" style="padding: 10px;">Add University</a></li>
								<li class="u-nav-item"><a class="u-button-style u-nav-link"
									href="#" style="padding: 10px;">Add User</a></li>
								<li class="u-nav-item"><a class="u-button-style u-nav-link"
									href="/courses/new" style="padding: 10px;">Add Course</a></li>
			...
			<form action="#" method="get"
				...
				<button class="u-search-button" type="submit">
					<span class="u-search-icon u-spacing-10"> <svg
							...
							<use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="#svg-3aec"></use></svg> <svg
							xmlns="http://www.w3.org/2000/svg"
							xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
							id="svg-3aec" x="0px" y="0px" viewBox="0 0 56.966 56.966"
	...
	<section class="u-align-center u-clearfix u-gradient u-section-1"
		...
		<div class="u-clearfix u-sheet u-sheet-1">
			<h2
				class="u-custom-font u-font-playfair-display u-text u-text-custom-color-1 u-text-1">Admin
				Page</h2>
				...
				<table class="u-table-entity u-table-entity-1">
					...
					<thead class="u-palette-5-dark-2 u-table-header u-table-header-1">
						<tr style="height: 71px;">
							<th
								class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-dark-1 u-table-cell">Course
								name</th>
							<th
								class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-dark-1 u-table-cell">Instructor
							</th>
							<th
								class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-dark-1 u-table-cell">Actions</th>
						</tr>
					</thead>
					<tbody class="u-palette-5-dark-3 u-table-body u-table-body-1">
						<c:forEach items="${courses}" var="course">
							<tr style="height: 64px;">
								<td
									class="u-border-1 u-border-palette-5-dark-1 u-table-cell u-table-cell-4">${course.name}</td>
								<td
									class="u-border-1 u-border-palette-5-dark-1 u-table-cell u-table-cell-5">${course.instructor }</td>
								<td
									class="u-border-1 u-border-palette-5-dark-1 u-table-cell u-table-cell-5">
									<a href="/courses/${course.id}/edit">Edit</a> <a
									href="/courses/${course.id}/delete">Delete</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
			...
			<div class="u-table u-table-responsive u-table-2">
				<table class="u-table-entity">
					...
					<thead class="u-palette-5-dark-2 u-table-header u-table-header-2">
						<tr style="height: 71px;">
							<th
								class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-dark-1 u-table-cell">User
								name</th>
							<th
								class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-dark-1 u-table-cell">University
								number</th>
							<th
								class="u-border-2 u-border-no-left u-border-no-right u-border-no-top u-border-palette-5-dark-1 u-table-cell">Actions</th>
						</tr>
					...
					<tbody class="u-palette-5-dark-3 u-table-body u-table-body-2">
						<c:forEach items="${users}" var="user">
							<tr style="height: 64px;">
								<td
									class="u-border-1 u-border-palette-5-dark-1 u-table-cell u-table-cell-19">${user.name}</td>
								<td
									class="u-border-1 u-border-palette-5-dark-1 u-table-cell u-table-cell-20">${user.student_number}</td>
								<td
									class="u-border-1 u-border-palette-5-dark-1 u-table-cell u-table-cell-21">
									<a href="/admin/users/${user.id}/edit">Edit</a> <a
	...
	<footer class="u-clearfix u-footer u-gradient u-footer" id="sec-6ea7">
		<div class="u-clearfix u-sheet u-sheet-1">
			<div
