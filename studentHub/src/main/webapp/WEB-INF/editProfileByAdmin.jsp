...
<body class="main-bg">
    <div class="login-container text-c animated flipInX">
            <div>
                ...
                <p class="text-whitesmoke">Edit User Profile</p>
            <div class="container-content">
                <form:form class="margin-t" method="POST" action="/admin/users/${user.id}" modelAttribute="user">
                    ...
                    <button type="submit" class="form-button button-l margin-b">Update!</button>
                </form:form>
